...
// Path to woocommerce .scss file.
const woocommerceStyleSRC = './assets/scss/woocommerce.scss';
...
const textDomain = 'wordpress-theme-repo';

// Name of the translation file.
const translationFile = 'wordpress-theme-repo.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'Wordpress_Theme_Repo';
